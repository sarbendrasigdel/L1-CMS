...
@include('layout.common.modal-spinner')
    @include('admin.pagesettings.price.partials.view')
    @include('admin.pagesettings.price.partials.add')
...
@section('additional-js')
    ...
    <script src="{{asset('assets/admin/custom/js/pagesettings/price.js')}}"></script>
