...
@include('layout.common.modal-spinner')
    @include('admin.pagesettings.Partners.partials.view')
    @include('admin.pagesettings.Partners.partials.add')
...
@section('additional-js')
    ...
    <script src="{{asset('assets/admin/custom/js/pagesettings/Partners.js')}}"></script>
