...
@include('layout.common.modal-spinner')
    @include('admin.pagesettings.portfolio-images.partials.view')
    @include('admin.pagesettings.portfolio-images.partials.add')
...
@section('additional-js')
    ...
    <script src="{{asset('assets/admin/custom/js/pagesettings/portfolioImages.js')}}"></script>
