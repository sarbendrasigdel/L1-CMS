...
@include('layout.common.modal-spinner')
    @include('admin.pagesettings.testimonials.partials.view')
    @include('admin.pagesettings.testimonials.partials.add')
...
@section('additional-js')
    ...
    <script src="{{asset('assets/admin/custom/js/pagesettings/testimonial.js')}}"></script>
