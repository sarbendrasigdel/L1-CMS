                    ...
                    <div class="content-box">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <form id="add-privacy-policy-form" autocomplete="off">
                                    @csrf
                                    <div class="row form-input-area align-items-center">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8 pl-lg-0">
                                                    ...
                                                    <textarea class="form-control"
                                                              placeholder="Description" id="backinputone" name="backinputone"> {!! @$privacyPolicy->description !!}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="col-sm-8 pl-lg-0">
                                                        <label class="switch">
                                                            <input type="checkbox" id="event-fee-switch1"
                                                                   name="active_status" value="1" {{@$privacyPolicy->active_status == '1'?'checked':'' }}>
                                        ...
                                        <div class="offset-md-4 pt-4">
                                            <button type="submit" class="btn form-button btn-success add-privacy-policy">Save</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
@section('additional-js')
    ...
    <script src="{{asset('assets/admin/custom/js/setting/terms-and-condition/privacy-policy.js')}}"></script>
@endsection
