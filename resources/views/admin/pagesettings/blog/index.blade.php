...
@include('layout.common.modal-spinner')
    @include('admin.pagesettings.blog.partials.view')
    @include('admin.pagesettings.blog.partials.add')
...
@section('additional-js')
    ...
    <script src="{{asset('assets/admin/custom/js/pagesettings/blog.js')}}"></script>
